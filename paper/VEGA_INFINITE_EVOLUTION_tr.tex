...
\title{VEGA INFINITE EVOLUTION: Kavramsal Bir Çerçeve}
...
\begin{abstract}
Bu çalışma, VEGA INFINITE EVOLUTION'i Resonance Data ve QIRC paradigması içinde yeni bir kavramsal çerçeve olarak tanıtmaktadır.
